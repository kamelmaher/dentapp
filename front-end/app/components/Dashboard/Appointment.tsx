...
import { checkExpired, getAppointmentDate, getAppointmentHour } from "~/utils/appointments"
...
const Appointment = ({ appointment }: AppointmentProps) => {
    ...
    const isExpired = checkExpired(appointment.date)
    return (
        <div
            ...
            <div>
                <div>
                    <div className="flex justify-between">
                        ...
                        {
                            isExpired &&
                            <p className="bg-blue-500 text-white p-[5px] rounded-2xl text-sm">
                                منتهي - {
                                    appointment.status == "accepted" ? "تم التأكيد" : "لم يتم التأكيد"
                                }
                            </p>
                        }
                    </div>
